...
ErrorHandler_._ERROR_MESSAGE_TRANSLATIONS = {
  ...
  "S-a înregistrat o eroare de server: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'ro' },
  "عذرًا، حدث خطأ في الخادم: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'ar' },
  "Vi beklager, det oppstod en tjenerfeil: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'no' },
  "К сожалению, произошла ошибка сервера: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'ru' },
  "Spiacenti, si è verificato un errore del server: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'it' },
  "מצטערים, אירעה שגיאת שרת: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'he' },
  "Tyvärr uppstod ett serverfel: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'sv' },
  "ขออภัย เกิดข้อผิดพลาดของเซิร์ฟเวอร์: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'th' },
  "Sajnáljuk, szerverhiba történt: DEADLINE_EXCEEDED": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'hu' },
  "Se ha producido un error en el servidor: DEADLINE_EXCEEDED.": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'es' },
  "Vabandame, serveris ilmnes viga: DEADLINE_EXCEEDED.": { ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED, locale: 'et' },
